"""
Tests for the common functions in the src.auth package.
"""
...
class TestAuthClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.path_to_resources = "./tests/auth/resources"
    ...
    def test_retrieve_configuration_object_non_existing_path(self):
        ...
        if the path does not exist.
        """
        res = src.auth.retrieve_configuration_object(
            os.path.join(
                self.path_to_resources, "I_WILL_NEVER_EXIST.json"
            )
        )
    ...
    def test_authenticate_to_server_empty_config_object(self):
        ...
        """
        self.assertIsNone(src.auth.authenticate_to_server(None))
    ...
    def test_authenticate_to_server_non_empty_config_object_404(self):
        ...
        is not 200.
        """
        config_obj = src.auth.auth_config.CoGuardCliConfig("foo", "bar")
        ...
        with unittest.mock.patch('requests.post',
            ...
            self.assertIsNone(src.auth.authenticate_to_server(config_obj))
    ...
    def test_authenticate_to_server_non_empty_config_object_success(self):
        ...
        with unittest.mock.patch('requests.post',
            ...
            result = src.auth.authenticate_to_server(config_obj)
    ...
    def test_store_config_object_in_auth_file(self):
        ...
        with unittest.mock.patch(
            ...
            src.auth.store_config_object_in_auth_file(
                config_object,
                "foo/bar/baz.conf"
            )
