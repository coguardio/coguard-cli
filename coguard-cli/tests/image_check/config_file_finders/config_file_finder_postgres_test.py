...
from src.image_check.config_file_finders.config_file_finder_postgres \
    import ConfigFileFinderPostgres

class TestConfigFileFinderPostgres(unittest.TestCase):
    """
    The class for testing the ConfigFileFinderPostgres module
    """
    ...
    def test_get_service_name(self):
        ...
        """
        self.assertEqual(ConfigFileFinderPostgres().get_service_name(), "postgres")
    ...
    def test_check_for_config_files_in_standard_location_not_existing(self):
        ...
        with unittest.mock.patch(
            ...
            self.assertIsNone(
                config_file_finder_postgres.check_for_config_files_in_standard_location(
                "foo"
            ))
        ...
        with unittest.mock.patch(
            ...
            unittest.mock.patch(
                "shutil.copy"
                 ...
                 ("src.image_check.config_file_finders.config_file_"
    ...
    def test_check_for_config_files_filesystem_search_not_existing(self):
        ...
        with unittest.mock.patch(
            ...
            config_file_finder_postgres = ConfigFileFinderPostgres()
            result = config_file_finder_postgres.check_for_config_files_filesystem_search(
                "foo"
            )
    ...
    def test_create_temp_location_and_manifest_entry(self):
        ...
        with unittest.mock.patch(
             ...
             unittest.mock.patch(
                 ("src.image_check.config_file_finders."
            ...
            self.assertEqual(result[0]["serviceName"], "postgres")
    ...
    def test_check_call_command_in_container_no_entrypoint_or_cmd(self):
        ...
        """
        config_file_finder_postgres = ConfigFileFinderPostgres()
        result = config_file_finder_postgres.check_call_command_in_container(
            "/",
            {
                "Config": {
                    "WorkingDir": ""
