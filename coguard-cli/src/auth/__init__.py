...
import requests
from src.auth.auth_config import CoGuardCliConfig
from src.api_connection import does_user_with_email_already_exist, sign_up_for_coguard
from src.print_colors import COLOR_TERMINATION, COLOR_RED, COLOR_CYAN, COLOR_YELLOW
