...
class ConfigFileFinderDockerCompose(ConfigFileFinder):
    ...
    def _create_temp_location_and_mainfest_entry(
        ...
        a tuple containing a manifest for a docker compose service and the path to the
        temporary location.
        """
        temp_location = tempfile.mkdtemp(prefix="coguard-cli-docker-compose")
