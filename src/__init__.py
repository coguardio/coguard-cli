...
from src.image_check import create_zip_to_upload_from_docker_image, docker_dao
from src.auth import DealEnum, \
    authenticate_to_server, \
    retrieve_configuration_object, \
    sign_in_or_sign_up
from src.api_connection import send_zip_file_for_scanning
from src.print_colors import COLOR_TERMINATION, COLOR_RED, COLOR_GRAY, COLOR_CYAN, COLOR_YELLOW
